...
'''
# Поиск всех слов, которые начинаются (\b-граница слова) с буквы "c" (\w - это любой символ), который
# * - повторяется 0 или более раз
print(re.findall(r'\bc\w*', mammoth))
# Найдите все четырехбуквенные слова, которые начинаются с "c"
...
# Упражнения 12-14
gif = '47494638396101000100800000000000ffffff21f9' + \
'0401000000002c000000000100010000020144003b'
gif = binascii.unhexlify(gif)
print(gif)
if gif[:6] == b"GIF89a":
    print('Valid GIF-image')
else:
    print('Not valid GIF-image')
